...
/*   Updated: 2023/05/30 18:19:19 by maltun           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_init_image(t_data *data, int imgx, int imgy)
{
	...
	data->img[4] = mlx_xpm_file_to_image(data->mlx, STAND1, &imgx, &imgy);
	data->img[5] = mlx_xpm_file_to_image(data->mlx, STAND1, &imgx, &imgy);
	data->img[6] = mlx_xpm_file_to_image(data->mlx, STAND1, &imgx, &imgy);
	data->img[7] = mlx_xpm_file_to_image(data->mlx, STAND1, &imgx, &imgy);
	data->img[8] = mlx_xpm_file_to_image(data->mlx, STAND1, &imgx, &imgy);
	data->img[9] = mlx_xpm_file_to_image(data->mlx, STAND1, &imgx, &imgy);
	data->img[10] = mlx_xpm_file_to_image(data->mlx, STAND1, &imgx, &imgy);
	data->img[11] = mlx_xpm_file_to_image(data->mlx, STAND1, &imgx, &imgy);
	data->img[12] = mlx_xpm_file_to_image(data->mlx, STAND1, &imgx, &imgy);
	data->img[13] = mlx_xpm_file_to_image(data->mlx, DOOR1, &imgx, &imgy);
	data->img[14] = mlx_xpm_file_to_image(data->mlx, DOOR1, &imgx, &imgy);
	data->img[15] = mlx_xpm_file_to_image(data->mlx, DOOR1, &imgx, &imgy);
	data->img[16] = mlx_xpm_file_to_image(data->mlx, COIN1, &imgx, &imgy);
	data->img[17] = mlx_xpm_file_to_image(data->mlx, STAND1, &imgx, &imgy);
	data->img[19] = mlx_xpm_file_to_image(data->mlx, STAND1, &imgx, &imgy);
	data->img[20] = mlx_xpm_file_to_image(data->mlx, STAND1, &imgx, &imgy);
